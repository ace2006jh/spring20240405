...
public class Controller33 {
    ...
    @GetMapping("sub4")
    public void method4() {
        mapper.insert1("hello world", "54321", "876.54", "2024-04-24", "1999-02-23 15:15:15");
    }
    ...
    public void method5() {
        ...
        LocalDateTime dateTimeVal = LocalDateTime.parse("1977-07-07T12:14:55");
        mapper.insert2(strVal, intVal, doubleVal, dateVal, dateTimeVal);
    }

    @GetMapping("sub6")
    public void method6() {
        String strVal = "fonder";
        String strVal2 = "dandy";
        Integer intVal = 75;
        Double doubleVal = 15.57;
        LocalDate dateVal = LocalDate.parse("1988-01-08");
        LocalDateTime dateTimeVal = LocalDateTime.parse("1977-07-07T12:14:55");
