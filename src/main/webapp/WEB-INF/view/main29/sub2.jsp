...
<c:if test="${not empty employee}">
    <div>
        번호 <input type="number" readonly value="${employee.id}">
    </div>
    <div>
    ...
    <div>
    메모 <input type="text" readonly value="${employee.notes}">
    </div>
    <div>
    사진 <input type="text" readonly value="${employee.photo}">
    </div>
    <div>
    생년월일 <input type="text" readonly value="${employee.birthDate}">
    </div>
